...
class MusicManager: NSObject {
    ...
    override init() {
        ...
        let s = Song()
        s.artistsName = "测试歌曲"
        s.audioURL = "sfasfjkhjksafhasjk.mp3"
        s.picURL = "https://wwww.baidu.com"
        s.artistsName = "dsfasfsaf"
        s.status = "1"
        s.salbumsName = "rongrong"
        //artistsName?.appending(" - ").appending(song.salbumsName
...
//        soundQueue?.clearQueue()
    ...
    func findMusicFileCachedPath(_ song: Song) -> String? {
        ...
        let downloadPath = ""//程平MZUtility.baseFilePath.appendPathComponents(["downloads",song.programID!])
